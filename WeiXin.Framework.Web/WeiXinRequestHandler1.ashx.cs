...
namespace WeiXin.Framework.Web
{
    ...
    /// 处理微信请求信息入口控制器
    /// </summary>
    public class WeiXinRequestHandler1 : IHttpHandler
    {
            ...
            try
            {
                switch (httpMethod)
                {
                    ...
                    case "POST":
                        ...
                        {
                            // 解析微信请求
                            //XElement requestXml = XElement.Load(@"C:\Users\Administrator\Desktop\WeiXin.Framework\WeiXin.Framework.Web\DotNetExtensions.xml");
